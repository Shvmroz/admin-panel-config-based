...
const Sidebar = ({ open, onClose, variant = "temporary" }) => {
  ...
  const sidebarContent = (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900 shadow-xl border-r border-gray-200 dark:border-gray-800">
      <Link to="/dashboard">
        <div className="cursor-pointer h-16 pl-8 border-b border-gray-200 dark:border-gray-800 flex items-center space-x-3">
